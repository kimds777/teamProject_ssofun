              ...
              <div class="col-2">
                ...
                <div class="col mt-3">
                    ...
                    <div class="row" style="margin-left: 10px;">
                        ...
                        <div class="col">
                           	<div class="row">
                                <div class="col-2"><p class="three-font mt-1" style="margin-left: 10px;">FAQ작성</p></div>
                                <div class="col c-five-font"><p class="five-font mt-2"></p></div>
                                <div class="col-2"></div>
							...
							<!--글작성 값넘김--> <form action="./systemAdminWriteFaqProcess" method="post" enctype="multipart/form-data"> 
		                        <div class="row">
		                            <div class="col">
		                                <div class="row"></div>
		                                <div class="row">
		                        ...
		                        <div class="row mt-3">
		                            ...
		                            <div class="col-10"><input type="text" name="title" id="title" class="form-control" placeholder="FAQ제목을 입력해주세요." aria-label="First name"></div>
		                            
		                        </div>
		                        <div class="row mt-3">
		                            <div class="col"><p class="six-font">FAQ내용</p></div>
		                            <div class="col-10"><textarea name="contents" id="contents" class="form-control" placeholder="유저가 자주찾는 질문에 대한 답변을 입력해주세요" id="floatingTextarea2" style="height: 250px;  resize: none;"></textarea></div>    
		        ...
		        <!--                  <div class="row  mt-3">
		                        ...
		                        <div class="row mt-2">
		                            ...
		                            <div class="col divcenter"><input type="submit" id ="faqCreateSubmit" class="faqCreateSubmit" value="등록하기"></div>    
		                            <div class="col"></div>
		                        </div>
