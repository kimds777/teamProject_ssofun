                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="d-flex row p-0">
					                <div class="col insert_box mb-3 pt-3"><a href="./adminMainPage">카테고리타입등록</a></div>
					            </div>
                           <form action="productCategoryTypeInsertProcess" method="post">
                              <div class="row">
                                 <div class="col-md-12 form-group mb-3">
                                    <label for="this_parent_id">상위카테고리</label>
                                    <input class="form-control" id="this_parent_id" name="this_parent_id" type="text" placeholder="상위카테고리를 입력하세요." />
                                    </div>
                                 <div class="col-md-12 form-group mb-3">
                                    <label for="node">최상위O</label>
                                    <input class="form-control" id="node" name="node" type="text" placeholder="node" />
                                 </div>
                                 <div class="col-md-12 form-group mb-3">
                                    <label for="categoryType_name">카테고리명</label>
                                    <input class="form-control" id="name" name="name" type="text" placeholder="카테고리명을 입력해주세요." />
                                 </div>
                                      <div class="col-md-12">
