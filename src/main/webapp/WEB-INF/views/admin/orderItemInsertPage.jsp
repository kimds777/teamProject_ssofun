            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                        <div class="card-title mb-3">주문아이템등록</div>
                           <form action="productOrderItemInsertProcess" method="post">
                              <div class="row">
                                 <div class="col-md-6 form-group mb-3">
                                    <label for="product_order_id">상품주문아이디</label>
                                    <input class="form-control" id="product_order_id" name="product_order_id" type="text" placeholder="상품주문아이디를 입력하세요." />
                                    </div>
                                 <div class="col-md-6 form-group mb-3">
                                    <label for="product_id">상품아이디</label>
                                    <input class="form-control" id="product_id" name="product_id" type="text" placeholder="상품아이디를 입력하세요." />
                                 </div>
                                 <div class="col-md-6 form-group mb-3">
                                    <label for="categoryType_name">배송아이디</label>
                                    <input class="form-control" id="delivery_recipient_id" name="delivery_recipient_id" type="text" placeholder="카테고리명을 입력해주세요." />
                                 </div>
                                 <div class="col-md-6 form-group mb-3">
                                    <label for="categoryType_name">수량</label>
                                    <input class="form-control" id="count" name="count" type="text" placeholder="수량을 입력해주세요." />
                                 </div>
                               	 <div class="col-md-12">
                              		<button class="btn btn-primary">상품구매</button>
                               	 </div>
                            	</div>
                           </form>
                            </div>
