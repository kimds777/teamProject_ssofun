                                ...
                                <h4 class="card-title mb-3">주문리스트</h4>
									<div class="table-responsive">
									    <table class="table table-striped">
									        ...
									        <tbody>
										        <c:forEach items="${productOrderItemList}" var="productOrderList">
										            <tr>
										            	<th scope="row">
										                ...
										                <td>${productOrderList.product_order_item_id}</td>
										                <td>${productOrderList.created_at}</td>
										                <td>${productOrderList.recipient_name}</td>
										                <td>${productOrderList.order_status_name}</td>
										                <td><a href="orderItemDetailPage?product_order_item_id=${productOrderList.product_order_item_id}">${productOrderList.product_name}</a></td>										                										      										    
										                <td>${productOrderList.count}</td>
										                <td>${productOrderList.price}</td>										                										                
										            </tr>
										        </c:forEach>
										    </tbody>
										</table>
