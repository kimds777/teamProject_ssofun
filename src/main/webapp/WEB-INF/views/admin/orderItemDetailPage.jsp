                                ...
                                <div class="card text-left">
                                    ...
                                    <div class="ul-widget__item">
		                                <div class="d-flex row p-0">
							                <div class="col title_box"><a href="./adminMainPage">주문상품</a></div>
							            </div>
                                    </div>
											...
											<div class="ul-widget__item">
												...
												<c:choose>
												    ...
												    <form id="orderStatusForm" action="orderStatusProcess" method="post">
												        ...
												        <input class="btn btn-outline-secondary m-1" type="submit" name="order_status_name" value="${orderItemDetail.order_status_name}">
							...
							<div class="col-md-6 col-lg-6 mt-4 mb-4 right_col">
                                <div class="card">
                                    <div class="card-body">
										<div class="ul-widget__item">
			                                <div class="d-flex row p-0">
								                <div class="col title_box"><a href="./adminMainPage">고객정보</a></div>
								            </div>
										</div>
                                        ...
                                        <div class="ul-widget1">
                                            <div class="ul-widget__item">
                                                ...
                                                </div><span class="ul-widget__desc text-mute">${orderItemDetail.recipient_name}&nbsp;님</span>
                                            </div>
                                            <div class="ul-widget__item">
                                                <div class="ul-widget__info">
                                   ...
                                   <div class="card mt-3">
                                    <div class="card-body">
                                    	<div class="ul-widget__item">
			                                <div class="d-flex row p-0">
								                <div class="col title_box"><a href="./adminMainPage">발송등록</a></div>
								            </div>
                                    	</div>
                                        <!-- begin::widget-stats-1-->
                                        <!-- form태그 -->
