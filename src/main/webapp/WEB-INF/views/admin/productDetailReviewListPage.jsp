                        ...
                        <div class="card text-left">
                            <div class="card-body">
                                <div class="d-flex row p-0">
					                <div class="col title_box mb-4 pt-3"><a href="./adminMainPage">상품리뷰리스트</a></div>
					            </div>
								<div class="table-responsive">
								    <table class="table table-striped">
										...
										<tbody>
										    <c:forEach items="${productReviewImageList}" var="productReviewImage" varStatus="imageStatus">
										        <tr>
										            <th scope="row">
