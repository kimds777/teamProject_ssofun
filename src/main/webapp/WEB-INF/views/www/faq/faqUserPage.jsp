                ...
                <div class="row ">
                    ...
                    <div class="col">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2" style="margin-right: 0px; text-align: center;"  ><button type="button" onclick="location.href='../faq/faqUserPage'"  style= "border:none; background-color:#FF6462; border-radius: 60px; height: 30px; width: 110px; cursor: pointer;" ><p class="four-font" style="color: white;">회원</p></button></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="row mt-5" style="height: 110px; border-style: thin white; border-radius: 10px; background-color: white;">
                                                                    ...
                                                                    <form action="./userHelpStatusProcess" method="post">
                                                                        <div class="row mt-2">
