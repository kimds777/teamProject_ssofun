    ...
    <div class="container text-center">	
        ...
        <div class="row section2" id="tab">
            <ul class="p-0 m-0">
                ...
                <li id="info"><a class="activeTab" href="./fundingDetailPage">소개</a></li>
            ...
            <div id="rewardModal" class="hide">
                <!-- <dl>
                    <dt>99,000<b>원</b></dt>
                    <dd class="ddFirst">3,000명이 선택</dd>
                    <dd class="ddNthTwo">&#91;쏘펀한정&#93; 올인원 패키지 1 + 1 	&#40;99종&#41;</dd>
                    <dd class="ddNthThree">
                        &lt;쏘펀 입점 기념 이벤트&gt;<br>
                    ...
                    <dd class="item">&#8226; 1ea당 26,950원</dd>
                    <dd class="item">&#8226; 구매시 배수구클리너 1봉 선물 증정</dd>
                    <dd><span>남은 수량</span> 300개</dd>
                    <dd class="ddLast"><span>발송 예정일</span> 2023. 06. 19 월요일 예정</dd>
                </dl> -->

            </div>
        </div>

        <div class="row section2" id="content"><p>상세설명</p></div>

        <!--여기부터 탭별로 변경 필요!-->

        <div class="row section2" id="similar">
            <div class="col">
        ...
        <div class="row section2" id="pick">
            <div class="col">
                <h5 class="row p-0">이 펀딩 서포터들의 PICK</h5>
