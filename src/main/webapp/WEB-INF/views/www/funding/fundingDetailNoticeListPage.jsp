...
<link rel="stylesheet" href="../../resources/css/funding_detailNoticeList.css">
<script src="../../resources/js/funding_detailNoticeList.js"></script>
</head>
<body>
    ...
    <div class="container text-center">	
        ...
        <div class="row section2" id="content">
            <!-- <div>
                ...
                <a href="./fundingDetailNoticePage" class="moreBtn">더보기</a>
            </div> -->
        </div>
